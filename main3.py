...
if __name__ == "__main__":
	try:
		client = MyClient(intents=discord.Intents.all(), debug=True, level="DEBUG")
		...
		async def _help(ctx):
			...
			embed_help.add_field(name=str(PREFIX + "roles"), value="Creates the server's roles embed.\nAdmin only feature.")
			embed_help.add_field(name=str(PREFIX + "stats"), value="Creates the server's stats embed.\nAdmin only feature.")
			embed_help.add_field(name=str(PREFIX + "locate"), value="Locates the instance of " + client.user.name + ".\nDev only feature.")
			embed_help.add_field(name=str(PREFIX + "kill"), value="Ends the instance of " + client.user.name + ".\nDev only feature.")
